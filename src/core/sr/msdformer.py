...
# Adapted from squashking/TechLauncher-HSISR, revision
# 98388e034e02e4e049a0816c7c9dcce74aa10683, Software.new_version/model/.
# This Source Code Form is subject to the terms of the Mozilla Public
# License, v. 2.0. See LICENSE in this directory.
# Inference-only adaptation; module/parameter names retain checkpoint compatibility.
...
from .common import default_conv, DeformConv2d, ResAttentionBlock, ResBlock, Upsampler
...
class DCTM(nn.Module):
    ...
    def __init__(self, dim, num_heads, shift_size=0, drop_path=0.0,
        ...
        if drop_path != 0:
            raise ValueError("This checkpoint uses inference with drop_path=0.")
